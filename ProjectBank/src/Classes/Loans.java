...
public class Loans {
    ...
    public String toString() {
        return "com.ProjectBank.Loans{totalAmount=" + this.totalAmount + ", details='" + this.details + "', dueDate='" + this.dueDate + "', interestRate=" + this.interestRate + ", monthlyPayment=" + this.monthlyPayment + ", interest=" + this.interest + "}";
    }
}
